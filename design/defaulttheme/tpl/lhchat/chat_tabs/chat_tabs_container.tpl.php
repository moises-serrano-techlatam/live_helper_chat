<div role="tabpanel">
	<ul class="nav nav-pills" role="tablist" id="chat-tab-items-<?php echo $chat->id?>">	
	    ...
	    <?php endif; ?>
	       ...
	       <?php elseif ($tabItem == 'extension_crm') : ?>
	       <?php include(erLhcoreClassDesign::designtpl('lhchat/chat_tabs/extension_crm.tpl.php'));?>  
	       <?php endif;?>
	    <?php endforeach; ?> 
	</ul>
	<div class="tab-content">
       ...
       <?php include(erLhcoreClassDesign::designtpl('lhchat/chat_tabs/extension_content_crm.tpl.php'));?> 
	</div>
</div>
